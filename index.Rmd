...
+ Dalgaard, P. (2008), *Introductory Statistics with R*. Springer. [Stanford Full Text](https://link.springer.com/book/10.1007/978-0-387-79054-1)
...
+ Stone, J. V. (2016), *Bayes' rule with R: a tutorial introduction to Bayesian analysis*. Sebtel Press.
...
+ Wickham, H. (2009), *ggplot2: Elegant Graphics for Data Analysis*. Springer. [Stanford Full Text](https://link.springer.com/book/10.1007%2F978-0-387-98141-3)
