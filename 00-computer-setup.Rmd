...
2. Attend the Git tutorial during class on Wednesday, October 4th (week 2).
...
2. Before you start working:
    + Make sure your copy is up to date with the FukamiLab repository on GitHub. If not, submit a Pull request to update it.
