...
Attend the git tutorial during class on Monday Oct 2nd (week 2).
...
3. That's it! You should now have three new programs installed in a folder called Git under your Progra Files.
...
The content of this webpage was derived from [Data Carpentry](http://datacarpentry.org) and [Software Carpentry](http://software-carpentry.org) materials (Copyriright (c) Data Carpentry) under CC-3.0 Attribution License (see [http://creativecommons.org/licenses/by/3.0/](http://creativecommons.org/licenses/by/3.0/)). 
